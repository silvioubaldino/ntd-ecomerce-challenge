...
- Approved the Cart contract (AYD-004): the guest Cart endpoints, quantity/stock rules (RN-03) and priced response are finalized as the source of truth for SPEC-004@api and SPEC-004@web.
